...
import (
	...
	"github.com/fabiosebastiano/golang-rest-api/pkg/swagger/server/restapi"
	"github.com/fabiosebastiano/golang-rest-api/pkg/swagger/server/restapi/operations"
...
func main() {
	...
	// Initialize Server REST API di Swagger
...
func GetHelloUser(user operations.GetHelloUserParams) middleware.Responder {
	return operations.NewGetHelloUserOK().WithPayload("Ciao " + user.User + "!")
}
